...
Questo modulo si limita a calcolare mean/std del rating sul train set (per
i sample dove rating non e' NaN) e li salva in un JSON minimo, cosi' il
modello puo' caricarli come costanti fisse all'inizializzazione invece di
ricalcolarli o di portarsi dietro un oggetto sklearn pickled (piu' pesante
e meno trasparente di due float in un json).
