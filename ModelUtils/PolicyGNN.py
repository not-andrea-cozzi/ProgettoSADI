...
class InputEncoder(nn.Module):
    ...
    def __init__(self, hidden_dim: int):
        ...
        # Scalari: has_piece, clock_norm, turn, is_check, 4x arrocchi (totale 8)
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # Unione di has_piece (0), clock (3) e global_scalars (4:10)
...
def build_head(in_dim: int, out_dim: int) -> nn.Sequential:
    """Helper per standardizzare le teste MLP."""
